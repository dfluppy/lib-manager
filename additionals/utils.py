...
def check_id(id: int, database: str) -> None:
    """
...
def get_first_to_last_id(database: str) -> tuple[int, int]:
    ...
    """
    ids: list[int] = [x for x in range(1, get_last_id(database) + 1)]
    return ids[0], ids[-1]


def get_status(status_id: int) -> str:
    """
